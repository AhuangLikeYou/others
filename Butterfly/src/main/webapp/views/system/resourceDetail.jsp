...
<form action="" method="post" id="form" class="form-horizontal mainForm">
    <input id="resourceId" name="resourceId" type="text" value="${resourceInfo.resourceId}" hidden="hidden"
           readonly="readonly">
    　
    ...
    <div class="form-group">
        <label for="resourceCode" class="col-sm-2 control-label">资源代码</label>
        <div class="col-sm-10">
            <input id="resourceCode" name="resourceCode" type="text" class="form-control" placeholder=""
                   value="${resourceInfo.resourceCode}"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input id="resourcePath" name="resourcePath" type="text" class="form-control" placeholder=""
                   value="${resourceInfo.resourcePath}">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select id="status" name="status" class="form-control" onchange="disable()">
                <option value="0"
                        <c:if test="${resourceInfo.status == '0'}">selected</c:if> >启用
                </option>
                <option value="1"
                        <c:if test="${resourceInfo.status == '1'}">selected</c:if> >锁定
                </option>
            </select>
        </div>
    </div>
...
<!-- JS START -->
<script type="text/javascript" src="<%=basePath%>js/system/resourceDetail.js"></script>
<!-- JS END -->
</html>
